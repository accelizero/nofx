        ...
        <div className="rounded-2xl p-5 relative overflow-hidden group hover:scale-105 transition-transform" style={{
          ...
          <div className="relative">
            ...
            <div className="text-xs" style={{ color: '#94A3B8' }}>
              {performance.winning_trades || 0}{t('win', language)} / {performance.losing_trades || 0}{t('loss', language)}
            </div>
          </div>
        </div>
                ...
                <div className="text-right mb-2">
                  <div className="text-sm font-bold px-3 py-1 rounded-lg" style={{
                    ...
                    {performance.sharpe_ratio >= 2 ? t('sharpeExcellent', language) :
                     ...
                     performance.sharpe_ratio >= 0 ? t('sharpeVolatile', language) : t('sharpeNeedsAdjust', language)}
                  </div>
                </div>
              )}
            </div>
            ...
            {performance.sharpe_ratio !== undefined && (
              <div className="rounded-xl p-4" style={{
                ...
                <div className="text-sm leading-relaxed" style={{ color: '#DDD6FE' }}>
                  ...
                  {performance.sharpe_ratio < 0 && t('sharpeNeedsAdjustDesc', language)}
                </div>
              </div>
            )}
          </div>
          ...
          <div className="relative">
            ...
            <div className="rounded-xl p-4" style={{
              ...
              <div className="text-sm leading-relaxed" style={{ color: '#FEF3C7' }}>
                {(performance.profit_factor || 0) >= 2.0 && t('profitFactorExcellent', language, { factor: (performance.profit_factor || 0).toFixed(1) })}
              ...
              <table className="w-full">
                <thead className="sticky top-0 z-10">
                  <tr style={{ background: 'rgba(15, 23, 42, 0.95)', backdropFilter: 'blur(10px)' }}>
                    <th className="text-left px-4 py-3 text-xs font-semibold" style={{ color: '#94A3B8' }}>{t('symbolColumn', language)}</th>
                    <th className="text-right px-4 py-3 text-xs font-semibold" style={{ color: '#94A3B8' }}>{t('tradesColumn', language)}</th>
                    <th className="text-right px-4 py-3 text-xs font-semibold" style={{ color: '#94A3B8' }}>{t('winRateColumn', language)}</th>
                    <th className="text-right px-4 py-3 text-xs font-semibold" style={{ color: '#94A3B8' }}>{t('totalPnLColumn', language)}</th>
                    <th className="text-right px-4 py-3 text-xs font-semibold" style={{ color: '#94A3B8' }}>{t('avgPnLColumn', language)}</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <div key={idx} className="rounded-xl p-4 backdrop-blur-sm transition-all hover:scale-[1.02]" style={{
                    ...
                    <div className="rounded-lg p-2 mb-2" style={{
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <span style={{ color: '#94A3B8' }}>{t('pnl', language)}</span>
