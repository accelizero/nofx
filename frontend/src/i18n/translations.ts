...
export const translations = {
  en: {
    ...
    // AI Learning Additional
    trades: 'Trades',
    win: 'W',
    loss: 'L',
    usdtAverage: 'USDT Average',
    sharpeRatio: 'Sharpe Ratio',
    sharpeRatioDesc: 'Risk-adjusted return · AI self-evolution metric',
    sharpeExcellent: '🟢 Excellent Performance',
    sharpeGood: '🟢 Good Performance',
    sharpeVolatile: '🟡 High Volatility',
    sharpeNeedsAdjust: '🔴 Needs Adjustment',
    sharpeExcellentDesc: '✨ AI strategy is very effective! Excellent risk-adjusted returns, can moderately expand positions while maintaining discipline.',
    sharpeGoodDesc: '✅ Strategy performance is stable, risk-return balance is good, continue maintaining current strategy.',
    sharpeVolatileDesc: '⚠️ Returns are positive but highly volatile, AI is optimizing strategy to reduce risk.',
    sharpeNeedsAdjustDesc: '🚨 Current strategy needs adjustment! AI has automatically entered conservative mode, reducing positions and trading frequency.',
    profitFactorExcellent: '🔥 Excellent profitability! For every 1 lost, can earn {factor} in profit, AI strategy performs excellently.',
    profitFactorGood: '✓ Strategy is stable and profitable, profit-loss ratio is healthy, continue maintaining disciplined trading.',
    profitFactorFair: '⚠️ Strategy is slightly profitable but needs optimization, AI is adjusting position sizing and stop-loss strategy.',
    profitFactorPoor: '❌ Average loss exceeds profit, need to adjust strategy or reduce trading frequency.',
    symbolColumn: 'Symbol',
    tradesColumn: 'Trades',
    winRateColumn: 'Win Rate',
    totalPnLColumn: 'Total P&L (USDT)',
    avgPnLColumn: 'Avg P&L (USDT)',
  ...
  zh: {
    ...
    sharpeNeedsAdjustDesc: '🚨 当前策略需要调整！AI已自动进入保守模式，减少仓位和交易频率。',
    profitFactorExcellent: '🔥 盈利能力出色！每亏1元能赚 {factor} 元，AI策略表现优异。',
    ...
    tradesColumn: '交易数',
    winRateColumn: '胜率',
    totalPnLColumn: '总盈亏 (USDT)',
    avgPnLColumn: '平均盈亏 (USDT)',
    marginUsed: '保证金使用',
  }
};
